...
public Q_SLOTS:
    ...
    *******************************************/
    ...
    void slot_quick_gazebo_clicked();
    void slot_quick_rviz_clicked();
    void slot_quick_Assem_clicked();
    void slot_quick_leader_clicked();
    void slot_quick_virtual1_clicked();
    void slot_quick_con_clicked();

    //宗门关闭
    void slot_quick_quit1_clicked();

    void slot_quick_stop1_clicked();
    void slot_quick_stop2_clicked();
    void slot_quick_stop3_clicked();
    ...
    void slot_display_ares1_RobotModel(int);
    void slot_display_ares2_RobotModel(int);
    void slot_display_ares3_RobotModel(int);
