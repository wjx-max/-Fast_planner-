...
public:
    ...
    void Display_ares1_RobotModel(QString ares1_topic,bool enable);
    void Display_ares2_RobotModel(bool enable);
    void Display_ares3_RobotModel(bool enable);
...
private:
    ...
    rviz::Display* ares1_RobotModel_=NULL;
    rviz::Display* ares2_RobotModel_=NULL;
    rviz::Display* ares3_RobotModel_=NULL;
