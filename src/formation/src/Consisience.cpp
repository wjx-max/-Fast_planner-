...
{   
    ...
    cur1_pose_yaw=msg->pose.pose.orientation.w;//四元数中的w值，表示旋转角度的标量部分 (s)。
     ...
     cur2_pose_x=msg->pose.pose.position.x-1.0;
     cur2_pose_y=msg->pose.pose.position.y+1.0;
    ...
    cur2_pose_yaw=msg->pose.pose.orientation.w;//四元数中的w值，表示旋转角度的标量部分 (s)。
     ...
     cur3_pose_x=msg->pose.pose.position.x-1,0;
     cur3_pose_y=msg->pose.pose.position.y-1.0;
