...
void SDFMap::initMap(ros::NodeHandle& nh) {
  ...
  indep_cloud_sub_2=
      node_.subscribe<sensor_msgs::PointCloud2>("/sdf_map/cloud2", 10, &SDFMap::cloudCallback2, this);
  indep_odom_sub_ =
...
void SDFMap::cloudCallback2(const sensor_msgs::PointCloud2ConstPtr& img) {
