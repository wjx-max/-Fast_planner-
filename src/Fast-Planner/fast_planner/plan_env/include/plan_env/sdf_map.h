...
private:
  ...
  void cloudCallback2(const sensor_msgs::PointCloud2ConstPtr& img);
  ...
  ros::Subscriber indep_depth_sub_, indep_odom_sub_, indep_pose_sub_, indep_cloud_sub_,indep_cloud_sub_2;
